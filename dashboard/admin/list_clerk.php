...
<head>
	...
	<link rel="stylesheet" href="../../neon/css/font-icons/font-awesome/font-awesome.min.css"  >
...
<table class="table table-bordered datatable"  id="table-1">
  <thead>
	...
	<?php
					$query  = "SELECT * FROM clerk ORDER BY date DESC";
					//echo $query;
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {	        
					        ...
					        echo "<td><form action='new_health_status.php' method='post'><input type='hidden' name='name' value='" . $row['id'] . "'/><input type='submit' value='Agragar Pago' class='btn btn-primary'/></form><form action='edit_invoice.php' method='post'><input type='submit' value='Editar Factura ' class='btn btn-warning'/></form></form></td></tr>";
					    	$hs_id = 0;
					    }
