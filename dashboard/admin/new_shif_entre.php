...
<h3>Entrega De Turno</h3>
<div align="center">
<form method="post" action="new_shif.php" class="form-horizontal form-groups-bordered">
...
<div class="form-group">
  <label  class="col-sm-3 control-label">Habitacion:</label>
    <div class="col-sm-5">
      <input type="text" name="room"  id="idcard" class="form-control" data-rule-minlength="5" placeholder="room" maxlength="11">
    </div> 
  </div>
    <div class="form-group">
  <label for="field-1" class="col-sm-3 control-label">Mecato:</label>
    <div class="col-sm-5">
      <input type="text" name="mecato"  id="phone" class="form-control" data-rule-minlength="5" placeholder="mecato" maxlength="11">
    </div>
    </div>
  <div class="form-group">
  <label for="field-1" class="col-sm-3 control-label">Firma :</label>
    <div class="col-sm-5">
      <input type="text" name="firm" id="textfield3" class="form-control" data-rule-required="true" data-rule-minlength="4" placeholder="firm" maxlength="50">
    </div>   
