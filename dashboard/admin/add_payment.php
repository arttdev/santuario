...
$consult="SELECT * FROM clerk WHERE idcard = '$idcard' ";
mysqli_query(con,$consult);
...
<div class="form-group">
  <label for="field-1" class="col-sm-3 control-label">Nombre :</label>
    <div class="col-sm-5">
      <input type="text" name="name" id="textfield3" value="
      <?php 
include 'connection.php';


      $consult="SELECT * FROM clerk WHERE idcard = '$idcard' ";
      if(mysqli_query($con,$consult)){
        echo 
      }
      

      ?>
      " class="form-control" data-rule-required="true" data-rule-minlength="4" placeholder="Member Name" maxlength="30">
    </div>
</div>
