...
<h3>Novedad</h3>
<div align="center">
<form method="post" action="new_fad.php" class="form-horizontal form-groups-bordered">
...
<div class="form-group">
  <label  class="col-sm-3 control-label">Novedad:</label>
    <div class="col-sm-5">
      <input type="text" name="fad"  id="fad" class="form-control" data-rule-minlength="5" placeholder="fad" maxlength="1000">
    </div> 
  </div>


  <div class="form-group">
  <label for="field-1" class="col-sm-3 control-label">Fecha De Novedad :</label>
    <div class="col-sm-5">
