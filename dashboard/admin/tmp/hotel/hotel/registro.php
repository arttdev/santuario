        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="http://localhost/master/?#">Pagina Web</a>
                    </li>
                    <li>
                        <a href="http://localhost/factura/?c=a2&guardar=guardar">Facturacion</a>
                    </li>
                    <li>
                        <a href="#"></a>
                    </li>
    ...
    <div class="container">
        ...
        <div id="encabezado" class="row">
            <div class="col-lg-12 text-center">
                ...
                <img src="img/Hotelsan.png" height="200" width="275">
            </div>
        </div>
        ...
        <form class="form-horizontal" action="php/registro.php" method= post id="">
                ...
                <label class="control-label col-xs-3" >Fecha de Llegada:</label>
                <div class="col-xs-6">
                    <input type="text" class="form-control" name="f_llegada" value="<?php 
$fecha = new DateTime();


$fecha1 = date_timezone_set($fecha, timezone_open('America/Bogota'));
echo $fecha1->format('Y-m-d H:i:s');
