...
<div class="row">
            <div class="col-lg-12 text-center">
                ...
                <img src="../img/Hotel.png" height="140" width="295">
            </div>
        </div>
</body>
...
$sentencia="INSERT INTO ".$tabla." (f_llegada,Nombre,Documento,tipodoc,de_doc,Nacionalidad,F_nacimiento,ocupacion,procedencia,destino,
	dir_residencia,ciudad_residencia,pais_residencia,telefono,genero,nota) VALUES ('$f_llegada','$nom','$doc','$tipo','$dedoc','$nac','$fn','$oc','$prov','$des',
	'$res','$city','$pais','$tel','$gen','$nota')";
