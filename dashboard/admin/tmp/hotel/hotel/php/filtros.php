...
<head>
    ...
    <title>Registro de Clientes-Hotel El Santuariox</title>
...
<body>
	...
	<div class="row">
            <div class="col-lg-12 text-center">
                ...
                <img src="../img/hotel.png" height="180

                " width="290">
                <h3>Arqueo Hotelero</h3>
            </div>
        </div>
...
<?php
   ...
   ?>
	...
	<?php	
		echo "<tr>";
  echo " <td> ".$fila['Nevera']. " </td>";  
  echo " <td> ".$fila['mecato']. " </td>";
  echo "<td> ".$fila['recepcion']. " </td>"; 
  echo "<td> ".$fila['aseo']. " </td>";
